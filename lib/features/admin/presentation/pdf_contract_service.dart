      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            // Use Partition to ensure this entire block stays on one page without breaking awkwardly
            pw.Partition(
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  ...
                  pw.SizedBox(height: 60), // Extra space for signature and stamp
                    ...
                    children: [
                      pw.Column(
                        ...
                        children: [
                          ...
                          pw.SizedBox(height: 4),
                          pw.Text('Authorized Signatory & Stamp', style: pw.TextStyle(fontSize: 10, color: textGrey, fontStyle: pw.FontStyle.italic)),
                        ],
                      ),
                      pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.center,
